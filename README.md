...
В полноэкранном просмотре доступны три похожие фотографии и возврат по истории. Кнопка `similar photos` сворачивает и раскрывает миниатюры, освобождая место для основного кадра; возврат остаётся доступным. Снимок, из которого только что пришли, исключается из предложений. Обычные стрелки и свайпы сохраняют порядок галереи. Если файл связей недоступен, обычный просмотр продолжает работать.
